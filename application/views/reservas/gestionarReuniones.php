...
<div class="row">
  <div class="col-md-12 text-center">
    <h3> <i class="fa fa-pen"> </i> Turnos Agendados </h3>
    <button type="button" name="button" onclick="location.reload();" class="btn btn-primary btn-sm">
      <i class="fa fa-undo"> </i> ACTUALIZAR LISTA DE TURNOS
    </button>
  </div>
</div>
<br>
  ...
  <div class="modal-dialog" style="min-width:90% !important;">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"> <i class="fa fa-eye"></i> <b>Detalle de Turno</b></h4>
